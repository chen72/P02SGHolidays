...
public class ListViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(option == 0){
            ...
            day.add(new Day("National Day", "9 August 2018"));
        }else{
            ...
            day.add(new Day("Hari Raya Puasa", "15 June 2018"));
            day.add(new Day("Vesak day", "29 May 2018"));
            day.add(new Day("Hari Raya Haji", "22 August 2018"));
            day.add(new Day("Deepavali", "6 November 2018"));
            day.add(new Day("Christmas Day", "25 December 2018"));
        }
